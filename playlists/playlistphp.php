...
<section class="playlist-videos">
   ...
   <div class="box-container">
         <?php
            $select  = "SELECT * FROM videos  WHERE type='php'";
         ...
         ?>
      <a class="box" href="../watch-video/php/watch-php-video.php?id=<?php echo $id; ?>&name=<?php echo $name; ?>&email=<?php echo $email; ?>&profilepic=<?php echo $profilepic; ?>">
