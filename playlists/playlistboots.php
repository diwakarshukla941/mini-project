...
<section class="playlist-videos">
   ...
   <div class="box-container">
      ...
      <a class="box" href="../watch-video/bootstrap/watch-video-bs.php">
         <i class="fas fa-play"></i>
         <img src="../images/thumb-4.png" alt="">
         <h3>complete BOOTSTRAP tutorial (part 01)</h3>
      </a>

      <a class="box" href="../watch-video/bootstrap/watch-video-bs2.php">
         <i class="fas fa-play"></i>
         <img src="../images/thumb-4.png" alt="">
         <h3>complete BOOTSTRAP tutorial (part 02)</h3>
      </a>

      <a class="box" href="../watch-video/bootstrap/watch-video-bs3.php">
         <i class="fas fa-play"></i>
         <img src="../images/thumb-4.png" alt="">
         <h3>complete BOOTSTRAP tutorial (part 03)</h3>
      </a>

      <a class="box" href="../watch-video/bootstrap/watch-video-bs4.php">
         <i class="fas fa-play"></i>
         <img src="../images/thumb-4.png" alt="">
         <h3>complete BOOTSTRAP tutorial (part 04)</h3>
      </a>

      <a class="box" href="../watch-video/bootstrap/watch-video--bs5.php">
         <i class="fas fa-play"></i>
         <img src="../images/thumb-4.png" alt="">
         <h3>complete BOOTSTRAP tutorial (part 05)</h3>
      </a>

      <a class="box" href="../watch-video/bootstrap/watch-video-bs6.php">
         <i class="fas fa-play"></i>
         <img src="../images/thumb-4.png" alt="">
