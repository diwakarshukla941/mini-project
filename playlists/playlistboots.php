...
<section class="playlist-videos">
   ...
   <div class="box-container">
      <?php 
            ...
            $select ="SELECT * FROM videos WHERE type='bootstrap'";
            ...
            while($row = mysqli_fetch_assoc($connect)){
               ...
               $id = $row['id'];
      ?>
      <a class="box" href="../watch-video/bootstrap/watch-video-bs.php?id=<?php echo $id; ?>&name=<?php echo $name; ?>&email=<?php echo $email; ?>&profilepic=<?php echo $profilepic; ?>">
